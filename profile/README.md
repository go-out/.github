# This is a Collection of Locations where visitors of this website have visited this website.

このウェブサイトに投稿[^1] された位置情報などを ウェブストレージ[^2] と CSV に保存し、このウェブサイトを訪れたみなさんがいた場所のコレクションを制作します。

位置情報 API (Geolocation API)[^1] を使用して取得した 現在位置 などの情報を、ウェブストレージ API[^2] ・ PHP[^3] を使用して ローカルストレージとCSV に記録し、
