...
const osakaFerry = {
    ...
    'features': [
        ...
        },
        {
            ...
            'geometry': {
                'type': 'Point',
                'coordinates': [135.45943595110674,34.667198902989526]
            },
            'properties': {
                'title': 'HELLO CYCLING',
                'address': 'セブンイレブン　大阪磯路2丁目店',
                'date': '<a href="https://maps.app.goo.gl/dTY69LFq8SGzP85B9" target="_blank">Google Map</a>',
                'iconSize': ['vr/icon/hello.jpg', '2.5rem', '2.5rem'],
                'tags': 'hello',
                'zoom': 16,
            }
